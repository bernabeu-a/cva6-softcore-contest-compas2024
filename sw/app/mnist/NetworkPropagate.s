...
.Ltext0:
	...
	.file 0 "/workdir/app" "mnist/NetworkPropagate.c"
	.align	2
	.globl	propagate
	.hidden	propagate
...
propagate:
.LFB60:
	.file 1 "mnist/NetworkPropagate.c"
	.loc 1 1283 1
	.cfi_startproc
.LVL0:
	addi	sp,sp,-64
...
.LBB450:
	...
	.loc 1 140 5
 #APP
# 140 "mnist/NetworkPropagate.c" 1
	custom2   a4, a5, a5
...
.LVL6:
	...
	.loc 1 383 42 is_stmt 0 discriminator 1
	ble	s8,s5,.L2
...
.LBB454:
	...
	.loc 1 125 5
 #APP
# 125 "mnist/NetworkPropagate.c" 1
	custom2   a4, t1, a5
...
.LBE503:
.LBE504:
	.loc 1 469 55 is_stmt 1 discriminator 2
	.loc 1 469 41 discriminator 1
	addi	s7,s7,1
	bne	t4,s9,.L7
.LBE480:
.LBE506:
	.loc 1 366 29 is_stmt 0 discriminator 1
	lw	s8,12(sp)
	.loc 1 366 46 is_stmt 1 discriminator 2
	.loc 1 366 29 discriminator 1
	addi	a0,a0,2
.LVL24:
	addi	s8,s8,16
...
.LBE508:
.LBE510:
	.loc 1 357 25 is_stmt 0 discriminator 1
	mv	a4,s6
.LVL25:
	.loc 1 357 43 is_stmt 1 discriminator 2
	.loc 1 357 25 discriminator 1
	addi	s3,a0,48
	addi	s2,s2,11
	bne	s6,s4,.L9
...
.LBB570:
	.loc 1 764 18
	.loc 1 764 33 discriminator 1
	lla	a3,conv2_weights
.LBE570:
.LBB571:
.LBB547:
...
.LBB577:
	.loc 1 842 18
.LVL52:
	.loc 1 842 41 discriminator 1
	lla	s6,.LANCHOR0+324
	lla	a4,conv2_weights+400
.LBE577:
	.loc 1 838 17 is_stmt 0 discriminator 1
	mv	s7,t2
.LVL53:
.L16:
.LBB641:
...
.LBE640:
.LBE578:
	.loc 1 842 55 is_stmt 1 discriminator 2
	.loc 1 842 41 discriminator 1
	addi	s6,s6,4
	addi	a4,a4,400
.LVL82:
...
.LBB697:
	.loc 1 1096 10
.LVL106:
	.loc 1 1096 27 discriminator 1
	lla	t1,.LANCHOR0+420
	lla	a4,fc1_weights+384
	lla	t3,mem+737
	lla	t0,.LANCHOR0+1016
.LBB698:
.LBB699:
.LBB700:
.LBB701:
...
.LBE769:
.LBE698:
	.loc 1 1096 44 is_stmt 1 discriminator 2
.LVL135:
	.loc 1 1096 27 discriminator 1
	addi	t1,t1,4
	addi	a4,a4,384
...
.LVL137:
	...
	lla	t3,mem+886
.LVL138:
	lla	a4,.LANCHOR0+1056
.LVL139:
	lla	a3,.LANCHOR0+1016
	mv	a1,t3
	mv	t6,a4
.LBE697:
.LBE658:
...
.Letext0:
	...
	.file 6 "mnist/conv1.h"
	.file 7 "mnist/conv2.h"
	.file 8 "mnist/fc1.h"
	.file 9 "mnist/fc2.h"
...
.LASF98:
	.string	"convcellPropagate2BufferVersion"
.LASF7:
	.string	"__int8_t"
.LASF124:
...
.LASF41:
	.string	"DATA_T"
.LASF113:
	.string	"convcellPropagate1BufferVersion"
.LASF115:
	.string	"shift"
.LASF79:
...
.LASF59:
	.string	"outputs"
.LASF118:
	.string	"MacsResultBufferVersion"
.LASF64:
	.string	"fc2_output"
.LASF122:
	.string	"iter"
...
.LASF45:
	.string	"WDATA_T"
.LASF97:
	.string	"fccellPropagateBufferVersionUDATA_T"
.LASF130:
	.string	"SetupMacsBuffer"
.LASF125:
	.string	"input_"
.LASF40:
	.string	"float"
...
.LASF120:
	.string	"CustomMacsOnRangeBufferVersion"
.LASF109:
	.string	"sxMin"
.LASF32:
	.string	"FastSigmoid"
...
.LASF1:
	.string	"/workdir/app"
.LASF0:
	.string	"mnist/NetworkPropagate.c"
